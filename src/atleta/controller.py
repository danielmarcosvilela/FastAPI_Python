...
@router.get('/', summary='Consultar todos os Atletas', status_code=status.HTTP_200_OK,
...
@router.get('/{id}', summary='Consulta um Atleta pelo id', status_code=status.HTTP_200_OK,
    response_model=AtletaOut,
)
...
@router.patch('/{id}', summary='Editar um Atleta pelo id', status_code=status.HTTP_200_OK,
    response_model=AtletaOut,
)
...
@router.delete('/{id}', summary='Deletar um Atleta pelo id',
